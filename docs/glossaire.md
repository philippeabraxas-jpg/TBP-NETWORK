...
Quick-reference extract of §14 from
...
**Adding a term**: edit the §14 table in `spec-v1.4.10.fr.md` first (it's
the source), then mirror it here. The two tables must stay word-for-word
