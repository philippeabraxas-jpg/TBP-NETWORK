...
**Note on language**: the core specification (`docs/spec-v1.4.3.md`) and
...
The full specification is **[`docs/spec-v1.4.3.md`](docs/spec-v1.4.3.md)**
...
```
docs/                 Specification (spec-v1.4.3.md), glossary, audits — currently French
