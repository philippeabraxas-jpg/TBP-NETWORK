...
**Note on language**: the core specification (`docs/spec-v1.4.6.md`) and
...
The full specification is **[`docs/spec-v1.4.6.md`](docs/spec-v1.4.6.md)**
...
```
docs/                 Specification (spec-v1.4.6.md), glossary, audits — currently French
